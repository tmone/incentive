...
{
    [RoutePrefix("api/Master/Service")]
    public class ServiceController : NCAPIController
    {
        ...
        {
              return Ok(base.Get("nc_master_service"));
        }
        //GET api/core/<controller>/<id>?token=
        [Route("{id:int}")]
        public IHttpActionResult Get(int id)
        {
              return Ok(base.Get("nc_master_service", id));
        }
        ...
        public IHttpActionResult Post([FromBody]FormDataCollection formDataCollection)
        {
            ...
            //return Ok();
            return Ok(base.Post("nc_master_service", formDataCollection));
        }
        //PUT api/core/<controller>/<id>?token=
        [Route("{id:int}")]
        public IHttpActionResult Put(long id, FormDataCollection formDataCollection)
        {
            return Ok(base.Put("nc_master_service", id, formDataCollection));
        }
        //DELETE api/core/<controller>/<id>?token=
        [Route("{id:int}")]
        public IHttpActionResult Delete(long id)
        {
            return Ok(base.Delete("nc_master_service", id));
