...
{
    public class LayoutController : NCAPIController
    {
        ...
        {
              return Ok(base.Get("nc_sc_layout"));
        }
        //GET api/core/<controller>/<id>?token=
        public IHttpActionResult Get(int id)
        {
              return Ok(base.Get("nc_sc_layout", id));
        }
