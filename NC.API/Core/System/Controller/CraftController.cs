...
{
    public class CraftController : NCAPIController
    {
        ...
        {
              return Ok(base.Get("nc_sc_craft"));
        }
        //GET api/core/<controller>/<id>?token=
        public IHttpActionResult Get(int id)
        {
              return Ok(base.Get("nc_sc_craft", id));
        }
