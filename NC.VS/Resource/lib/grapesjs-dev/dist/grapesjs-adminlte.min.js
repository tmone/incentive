(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["grapesjs-adminlte"] = factory(require("grapesjs"));
	else
		root["grapesjs-adminlte"] = factory(root["grapesjs"]);
...
exports.default = _grapesjs2.default.plugins.add('grapesjs-adminlte', function (editor) {
...
exports.default = function (editor) {
  ...
  if (cats.layout) {
    ...
    if (blocks.wrapper) {
      domc.addType('wrapper', {
        model: defaultModel.extend({
          ...
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('content-header')) {
              return { type: 'content_header' };
            }
          }
        }),
        view: defaultView
    ...
    if (blocks.content_header) {
      domc.addType('content_header', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Content Header',
            tagName: 'section',
            droppable: true,
            draggable: '.wrapper'
    ...
    if (blocks.content_footer) {
      domc.addType('content_footer', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Content Footer',
            tagName: 'footer',
            droppable: true,
            draggable: '.wrapper'
          })
          ...
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('main-footer')) {
              return { type: 'content_footer' };
            }
          }
        }),
        view: defaultView
    ...
    if (blocks.aside) {
      domc.addType('aside', {
        model: defaultModel.extend({
          ...
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('main-sidebar')) {
              return { type: 'aside' };
            }
          }
        }),
    ...
    if (blocks.box) {
      domc.addType('box', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            ...
            traits: [{
              type: 'class_select',
              options: [{ value: 'box-default', name: 'Default' }, { value: 'box-primary', name: 'Primary' }, { value: 'box-info', name: 'Info' }, { value: 'box-warning', name: 'Warning' }, { value: 'box-success', name: 'Success' }, { value: 'box-danger', name: 'Danger' }],
              label: 'Color'
            }, {
              type: 'class_select',
              options: [{ value: '', name: 'no' }, { value: 'box-solid', name: 'yes' }],
              label: 'Solid'
            }, {
              type: 'class_select',
              options: [{ value: '', name: 'no' }, { value: 'collapsed-box', name: 'yes' }],
              label: 'Collapsed'
            }]
          })
        }, {
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('box')) {
              return { type: 'box' };
            }
          }
        }),
      ...
      domc.addType('box_header', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Box Header',
            tagName: 'div',
            classes: ['box-header', 'with-border'],
            traits: [{
              type: 'class_select',
              options: [{ value: 'with-border', name: 'Yes' }, { value: '', name: 'No' }],
              label: 'Border'
            }]
          })
        }, {
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('box-header')) {
              return { type: 'box_header' };
            }
          }
        }),
        view: defaultView
      });
      domc.addType('box_title', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Box Title',
            tagName: 'h3',
            classes: ['box-title']
          })
        }, {
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('box-title')) {
              return { type: 'box_title' };
            }
          }
        }),
        view: defaultView
      });
      domc.addType('box_tools', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Box Tools',
            tagName: 'div',
            classes: ['box-tools', 'pull-right']
          })
        }, {
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('box-tools')) {
              return { type: 'box_tools' };
            }
          }
        }),
        view: defaultView
      });
      domc.addType('box_tools_btn', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Box Tools Command',
            tagName: 'button',
            classes: ['btn', 'btn-box-tool'],
            traits: ['data-widget']
          }),
          init2: function init2() {
            //textModel.prototype.init.call(this);
            this.listenTo(this, 'change:data-widget', this.setupDataWidget);
          },
          setupDataWidget: function setupDataWidget(a, b) {
            var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
            // this should be in the dropdown comp and not the link comp
            if (options.ignore === true && options.force !== true) {
              return;
            ...
            attrs['data-widget'] = this.model.get('value');

            this.set('attributes', attrs, { ignore: true });
          }
        }, {
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('btn-box-tool')) {
              return { type: 'box_tools_btn' };
            }
          }
        }),
        view: defaultView
      });
      domc.addType('box_body', {
        model: defaultModel.extend({
          defaults: Object.assign({}, defaultModel.prototype.defaults, {
            'custom-name': 'Box Body',
            tagName: 'div',
            classes: ['box-body'],
            droppable: true,
            draggable: true
          ...
          isComponent: function isComponent(el) {
            if (el && el.classList && el.classList.contains('box-body')) {
              return { type: 'box_body' };
            }
          }
        }),
        view: defaultView
          ...
          isComponent: function isComponent(el) {
            ...
            if (el && el.classList) {
              el.classList.forEach(function (klass) {
                if (klass == "column" || klass.match(/^col-/)) {
                  match = true;
                }
              });
            }
...
exports.default = function (editor) {
  ...
  if (cats.layout) {
    ...
    if (blocks.content_header) {
      bm.add('content_header').set({
        label: c.labels.content_header,
        category: 'Section',
        attributes: { class: 'fa fa-bars' },
        content: {
          type: 'content_header',
    ...
    if (blocks.content_footer) {
      bm.add('content_footer').set({
        label: c.labels.content_footer,
        category: 'Section',
        attributes: { class: 'fa fa-bars' },
        content: {
          type: 'content_footer',
