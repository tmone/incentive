...
var SyncRevenue = (function () {

    var SyncRevenue = function (options) {
        var options = options || {};
        this.Name = "SyncRevenue";
        ...
        this.Init = function () {
            ...
            var loadOracleData = function (dat) {
                ...
                //CTM
                $.ajax({
                    url: getURL(`api/Accounting/Report/QO?t=nc_accounting_temp_customer&q=
                                SELECT CASE
                    ...
                    DevExpress.ui.notify("Updated CTM");
                });
                ...
                //DTY
                $.ajax({
                    url: getURL(`api/Accounting/Report/QO?t=nc_accounting_temp_revenue&q=
                    ...
                    DevExpress.ui.notify("Updated DTY");
                });
                ...
                //HD
                $.ajax({
                    url: getURL(`api/Accounting/Report/QO?t=nc_accounting_temp_bill&q=
                                SELECT MA_KH,
                                    A.SO_VAN_DON,
                                    TIEN_HD,
                    ...
                    DevExpress.ui.notify("Updated HD");
                });
                ...
                //DC
                $.ajax({
                    url: getURL(`api/Accounting/Report/QO?t=nc_accounting_temp_discount&q=
                    ...
                    DevExpress.ui.notify("Updated DC");
                });
                ...
                //INV
                $.ajax({
                    url: getURL(`api/Accounting/Report/QO?t=nc_accounting_temp_invoice&q=
                                SELECT (SELECT VALUE
                                        FROM AD_ORG
                    ...
                    DevExpress.ui.notify("Updated INV");
                });
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined')
    ...
    window.SyncRevenue = SyncRevenue;