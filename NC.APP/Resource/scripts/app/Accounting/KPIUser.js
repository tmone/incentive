...
var KPISaler = (function () {
    ...
    var KPISaler = function (options) {
        ...
        this.Init = function () {
            ...
            var fixSettingStore = [];
            var settingStore = new NCData({
                url: 'api/Accounting/KPISetting',
                callback: function (a) {
                    that.Component.columnOption('kpi_id', 'lookup.dataSource', a);
                    fixSettingStore = a.map((x) => {
                        return Object.assign({
                            exp: a.filter(y => y.parent == x.id).length > 0,
                            code_name: '[' + x.name + '] ' + x.description
                        }, x);
            ...
            var userStore = new NCData({
                ...
                callback: function (a) {
                    ...
                    that.Component.columnOption('parent', 'lookup.dataSource', a);
                }
            });
